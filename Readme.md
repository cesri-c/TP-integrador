...
- Directorios comprimidos: `root.tar.gz`, `etc.tar.gz`, `opt.tar.gz`, `proc.tar.gz`, `www_dir.tar.gz`, `backup_dir.tar.gz`
- Automatización de backups con `cron`
- Servicios configurados: Apache, MariaDB, SSH

## Topología del sistema

- **Sistema base:** VM Debian 11 con IP estática `192.168.1.50`
